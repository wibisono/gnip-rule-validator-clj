Clojure [Instaparse](https://github.com/jeroenr/gnip-rule-validator) port of original [Fastparse](https://github.com/jeroenr/gnip-rule-validator) version from Jeroen.
